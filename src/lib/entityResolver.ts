...
export function buildResolverInstructions(): string {
  ...
  return [
    ...
    "",
    "Important polarity rule: the parser tracks assertion/negation separately. If",
    "a finding names an in-scope feature, return that feature id even when the",
    "context negates it (for example no anomalous LCX origin, no calcifications,",
    "no myocardial bridge, or CAD-RADS 0/no CAD). Use \"none\" only for normal",
    "anatomy or concepts outside the catalog. Do not label normal vessel-sinus",
    "pairings as anomalous solely because the words origin/cusp/sinus appear.",
    "",
